...
import { Text, Button, Card, Icon, CardItem, Body, Content } from "native-base";
import { Linking, StyleSheet } from "react-native";
import { Screen } from "app/components";

export default class ContactUs extends React.Component {
  onFindBranch = function() {
    this.props.navigation.navigate("Find a Location", {
      filter: "Branch"
    });
  };
        ...
        <Content>
          <Card>
            <CardItem bordered>
              <Body>
                <Text style={styles.headerPadding}>
                  <Icon name="old-phone" type="Entypo" /> By phone
                </Text>
                ...
                <Text>
                  ...
                  <Text
                    ...
                    onPress={() => this.callSupport("1-800-555-5555")}
                  >
                    1-800-555-5555
                  </Text>
                </Text>
                <Text>
                  ...
                  <Text
                    style={styles.clickable}
                    onPress={() => this.callSupport("1-800-444-4444")}
                  >
                    1-800-444-4444
                  </Text>
                </Text>
            ...
            <CardItem bordered>
              <Body>
                ...
                <Text>
                  ...
                  <Text
                    style={styles.clickable}
                    onPress={() => this.emailSupport("eraji035@uottawa.ca")}
                  >
                    abc@cba.ca
                  </Text>
                </Text>
            ...
            <CardItem bordered>
              <Body>
                <Text style={styles.headerPadding}>
                  <Icon name="location" type="Entypo" /> Stop by anytime
                </Text>
